export default {
  ...
  sectionPage: {
    ...
    brandDesc1:
      'BIZZAN was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.',
    brandDesc2:
      'BIZZAN is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.',
  ...
  ctc: {
    ...
    desc:
      'Crypto assets are managed by BIZZAN, and the acceptor provides exchange services for exchange.',
    buyin: 'Buy',
    sell: 'Sell',
    buyprice: 'Buy Price',
    sellprice: 'Sell Price',
  ...
  activity: {
    ...
    attentiontxt4:
      '* The right of final interpretation of this activity belongs to the official ownership of BIZZAN.',
  ...
  invite: {
    ...
    ruletext8:
      '8、TOP10 or TOP100 will be awarded additional incentives by BIZZAN from time to time.',
    ruletext9:
    ...
    pt_tips:
      'If you have a good idea, please send an email to promotion@bizzan.com, with a reward after adoption.！',
    ...
    pt_card_rule2:
      '2. Free gift cards are limited to one copy per user. Free gift cards issued by the BIZZAN government are limited to one for each user. Even if different users receive free gift cards with different exchange codes, only one can be exchanged. Custom gift cards are not subject to this restriction.',
    pt_card_rule3:
    ...
    pt_card_rule6:
      '6. The right of final interpretation of free gift cards belongs to BIZZAN.COM.',
    pt_card_day: 'Days',
  ...
  uc: {
    ...
    identity: {
      ...
      become:
        'Become BIZZAN Certified Business and enjoy more transaction privileges',
      zhusnhu:
  ...
  plate: {
    ...
    content1:
      'As described in the white paper, BIZZAN will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.',
    content2:

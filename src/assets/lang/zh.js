export default {
  ...
  sectionPage: {
    ...
    brandDesc2:
      'BIZZAN.COM定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。',
  ...
  otc: {
    ...
    publishad: {
      createad: '创建一个广告交易',
      msg1:
        '如果您经常进行交易，您可以创建自己的交易广告。如果您只是偶尔交易，我们建议您直接搜索',
      msg2: '创建一则交易广告是',
      msg3: '免费的',
      ...
      tip4: '请输入您的最大交易额',
      tip5:
        '可以内备注信息里填写您的特殊要求，例如：对买方的要求，在线时间等。',
      paymode: '付款方式',
      minlimit: '最小交易额',
      maxlimit: '最大交易额',
      remark: '备注信息',
      ...
      msg5:
        '启用后，用户通过此广告向您发起交易时，系统自动将您选择的自动回复用语发送给对方。',
      autoreply: '自动回复',
      autoreplytip:
  ...
  activity: {
    ...
    attention: '注意',
    attentiontxt1:
      '1、提交参与【持仓瓜分】、【自由认购】、【云矿机认购】类型活动后将冻结资产，活动结束后解冻',
    attentiontxt2:
      '2、参与【持仓瓜分】、【自由认购】、【云矿机认购】类型活动后，用户不得撤销参与申请',
    attentiontxt3:
  ...
  invite: {
    ...
    ruleprofile4:
      '的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与币严(BIZZAN)交易平台共同成长的红利！具体细则如下：',
    ruletext1:
      '一、为布道数字资产理念与扩大用户规模，币严(BIZZAN)推出【推广合伙人】计划，该活动长期有效。',
    ruletext2:
    ...
    ruletext8:
      '八、推广返佣排行榜TOP10或TOP100不定期会获得由币严(BIZZAN)官方发放的额外奖励。',
    ruletext9:
    ...
    pt_more: '更多工具，敬请期待',
    pt_tips:
      '如果您有好的创意，请发送邮件至promotion@bizzan.com，采纳后有奖励哦！',
    pt_card_amount: '卡面金额',
    ...
    pt_card_rule2:
      '二、免费礼品卡每个用户限兑1份。由币严(BIZZAN)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。',
    pt_card_rule3:
  ...
  description: {
    ...
    message5:
      '币严(BIZZAN)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
    scanqrcode: '扫描二维码，下载APP',
    aboutdesc1:
      '币严(BIZZAN)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。币严(BIZZAN)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。',
    aboutdesc2:
      '币严(BIZZAN)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。',
    aboutdesc3:
      '币严(BIZZAN)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。',
    aboutdesc4:
      '币严(BIZZAN)严格筛选优质项目并提供安全稳定的资产托管服务。币严(BIZZAN)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。',
    aboutdesc5:
  ...
  plate: {
    ...
    content1:
      '正如白皮书所描述的，BIZZAN会拿出平台的80% (扣除税费后) 的收入分配给BIZZAN持有者，20%的收入用来支持平台的研发及运营。',
    content2:
